...
class Placemarker(
    ...
    override fun toString(): String {
        ...
        /*
        println("Placemaker obj $this")
        println("Level: ${this.level}")
        println("xLocation: ${this.xLocation}")
        println("yLocation: ${this.yLocation}")
        println("BestTime: ${this.bestTime.toString()}")
        println("Complete?: ${this.complete}")
         */
    }
